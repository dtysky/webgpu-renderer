...
}`,Ft=`let WINDOW_SIZE: i32 = \${WINDOW_SIZE};
...
}`,Rt=`@stage(compute) @workgroup_size(16, 16, 1)
fn main(
  @builtin(workgroup_id) workGroupID : vec3<u32>,
  @builtin(local_invocation_id) localInvocationID : vec3<u32>
) {
...
}`,Bt=`let PI: f32 = 3.14159265358979;
